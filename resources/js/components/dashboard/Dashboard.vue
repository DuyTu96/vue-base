                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <div class="album">
                                                    <a href="#">
                                                        <img alt="" src="Assets-Admin/img/sm-img-1.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="Assets-Admin/img/sm-img-2.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="Assets-Admin/img/sm-img-3.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="Assets-Admin/img/sm-img-1.jpg">
                                                    </a>
                        ...
                        <div class="panel-footer revenue-foot">
                            <ul>
                                <li class="first active">
                                    <a href="javascript:;">
                                        <i class="fa fa-bullseye"></i> Graphical
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;">
                                        <i class=" fa fa-th-large"></i> Tabular
                                    </a>
                                </li>
                                <li class="last">
                                    <a href="javascript:;">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <ul class="ft-link">
                                ...
                                <li>
                                    <a href="javascript:;">
                                        <i class=" fa fa-calendar-o"></i> promo
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;">
                    ...
                    <section class="panel post-wrap pro-box">
                        ...
                        <aside class="post-highlight yellow v-align">
                            <div class="panel-body text-center">
                                <div class="pro-thumb">
                                    <img src="Assets-Admin/img/ring.jpg" alt="">
                                </div>
                            </div>
                        </aside>
                    </section>
                                ...
                                <div class="follower">
                                    <div class="panel-body">
                                        ...
                                        <div class="follow-ava">
                                            <img src="Assets-Admin/img/follower-avatar.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
